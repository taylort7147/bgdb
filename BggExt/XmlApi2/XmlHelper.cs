...
public static class XmlHelper
{
    ...
    public static T GetAttributeValueOrDefault<T>(this XElement? element, string attrName, T defaultValue,
        IFormatProvider? formatProvider = null)
        where T : IParsable<T>
    {
        if (element != null)
    ...
    public static T GetElementValueOrDefault<T>(this XElement? element, T defaultValue,
        IFormatProvider? formatProvider = null)
        where T : IParsable<T>
    {
        if (element != null)
